<div class="banner-area bg-relative banner-area-1 pd-bottom-100 bg-cover"
     style="background-image: url('{{ asset('assets/img/banner/0.png') }}');">
    <img class="animate-img-1 top_image_bounce" src="{{ asset('assets/img/banner/2.png') }}" alt="img">
                        ...
                        <div class="col-lg-6 align-self-center">
                            <div class="banner-inner pe-xl-5">
                                ...
                                <a class="btn btn-border-base wow animated fadeInLeft" data-wow-duration="1.5s"
                                   data-wow-delay="0.6s"
                                   href="{{ url('https://novajii.com/ords/f?p=bulksms:register') }}">Get Started</a>
                            </div>
                        </div>
