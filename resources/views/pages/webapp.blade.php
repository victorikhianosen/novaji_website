...
<div class="banner-area bg-relative banner-area-2 bg-cover" style="background-image: url('{{ asset('assets/img/banner-3/5.png') }}');">
    <img class="bg-img-2" src="{{ asset('assets/img/banner-3/4.png') }}" alt="img">
    <div class="container">
        <div class="row">
            <div class="col-lg-6 align-self-center">
                <div class="banner-inner pe-xl-5">
                    <h2 class="title wow animated fadeInLeft" data-wow-duration="1.5s" data-wow-delay="0.4s">Web App <span>Financial</span> Freedom</h2>
                    ...
                    <a class="btn btn-border-base wow animated fadeInLeft" data-wow-duration="1.5s" data-wow-delay="0.6s" href="about.html">Get start </a>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-service-inner style-3">
                    ...
                    <div class="details">
                        ...
                        <p>You can access SaaS applications through a web browser or mobile app, as long as you have an internet connection</p>
                        <a class="read-more-text" href="https://novajii.com/ords/f?p=bulksms:register">Learn
                             More </a>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6">
                <div class="single-work-process-inner-3 text-center">
                    ...
                    <img src="{{ asset('assets/img/testimonial/6.png') }}" alt="img">
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
                <div class="single-work-process-inner-3 text-center">
                    ...
                    <h5 class="mb-4">Zero to app in no time</h5>
                    <img src="{{ asset('assets/img/testimonial/7.png') }}" alt="img">
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
                <div class="single-work-process-inner-3 text-center">
                    ...
                    <h5 class="mb-4">Zero to app in no time</h5>
                    <img src="{{ asset('assets/img/testimonial/8.png') }}" alt="img">
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
                <div class="single-work-process-inner-3 text-center">
                    ...
                    <h5 class="mb-4">Zero to app in no time</h5>
                    <img src="{{ asset('assets/img/testimonial/9.png') }}" alt="img">
                </div>
            </div>
        </div>
    </div>
