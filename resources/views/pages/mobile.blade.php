        ...
        <div class="row">
            <div class="col-lg-6 align-self-center">
                <div class="banner-inner pe-xl-5">
                    ...
                    <a class="btn btn-border-base wow animated fadeInLeft" data-wow-duration="1.5s" data-wow-delay="0.6s" href="{{ url('about.html') }}">Get start </a>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 wow animated fadeInRight" data-wow-duration="1.5s" data-wow-delay="0.3s">
                <div class="section-title mb-0">
                    ...
                    <a class="btn btn-border-base" href="{{ url('about.html') }}">Get started </a>
                </div>
            </div>
        </div>
